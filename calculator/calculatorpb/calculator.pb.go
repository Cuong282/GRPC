...
var file_calculatorpb_calculator_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x75, 0x6c, 0x74, 0x32, 0x97, 0x01, 0x0a, 0x0a, 0x43, 0x61, 0x6c, 0x63, 0x75, 0x6c,
	0x61, 0x74, 0x6f, 0x72, 0x12, 0x38, 0x0a, 0x03, 0x53, 0x75, 0x6d, 0x12, 0x16, 0x2e, 0x63, 0x61,
...
var file_calculatorpb_calculator_proto_depIdxs = []int32{
	...
	3, // 3: calculator.Calculator.PrimeNumberDecomposition:output_type -> calculator.PNDResponse
...
func file_calculatorpb_calculator_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_calculatorpb_calculator_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_calculatorpb_calculator_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_calculatorpb_calculator_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_calculatorpb_calculator_proto_msgTypes[3].Exporter = func(v any, i int) any {
